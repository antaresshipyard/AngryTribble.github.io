module.exports = [{
	...
	name: "Lwaxana Troi",
	cost: 3,
	text: "<b>Not Released Yet</b>\n<b>NEGOTIATIONS ACCEPTED</b>: At the start of the game target a Captain or [crew] Upgrade equipped to the target ship. Whenever this ship moves within Range 1 of target ship, disable the Captain equipped to this ship and the target Captain or [crew] Upgrade.\n<b>NEGOTIATIONS DENIED</b>: Place 3 [time] Tokens and a Disable Token on the target Captain or [crew] Upgrade.",
	unique: true,
	factions: ["federation"]
},{
	type: "ambassador",
	...
	name: "Sarek",
	cost: 3,
	text: "<b>Not Released Yet</b>\n<b>NEGOTIATIONS ACCEPTED</b>: When this ship and the target ship are within Range 1-3 of each other, neither ship may target the other with an attack unless there are no other targets.\n<b>NEGOTIATIONS DENIED</b>: Place 3 [time] Tokens on all [weapon] Upgrades equipped to the target ship.",
	unique: true,
