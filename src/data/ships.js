module.exports = [{
	...
	id: "S340",
	set: ["75011"],
	name: "U.S.S. Tian AN Mien",
	class: "Miranda Class",
	actions: ["evade", "target-lock", "scan", "battlestations"],
	upgrades: ["tech","weapon","crew", "crew"],
	text: "<b>Not Released Yet</b>\n<b>ACTIVATION PHASE:</b> Target a friendly ship within Range 1-3 that has an [aux] Token beside it and place 2 [time] Tokens on a [crew] Upgrade equipped to this ship.\nThe target ship does not skip its Perform Action Step this game round.",
	attack: 2,
	agility: 2,
	hull: 3,
	shields: 3,
	...
	shields: 3,
	cost: 21,
	text: "<b>Not Released Yet</b>\nYou may equip a Klingon [tech] Upgrade with a printed cost of 4 SP or less to this ship for free, even if it exceeds this ship's retrictions. (Utopia Note: Code not yet implemented)",
	unique: true,
	factions: ["klingon"],
	squadron: false
},{
	...
	shields: 3,
	cost: 21,
	text: "<b>Not Released Yet</b>\n\n<b>FREE ACTION:</b> Perform a [sensor-echo] Action even if this ship is not Cloaked.  If this ship is Cloaked you may use a 3 [straight] Manuever tamplate for this action.",
	unique: true,
	factions: ["klingon"],
	squadron: false
},{
