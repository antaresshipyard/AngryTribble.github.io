...
{	 type: "captain",
	 ...
	 name: "Worf",
	 unique: true,
	 text: "<b>Not Released Yet</b>\n<b>WHEN ATTACKING:</b> During the Modify Attack Dice Step, spend a [battlestations] Token beside this ship.\n\nConvert all [blank] to [hit].",
...
{	 type: "captain",
	 ...
	 name: "Jadzia Dax",
	 unique: true,
	 text: "<b>Not Released Yet</b>\nYou do not pay a faction penalty when equipping Klingon [talent] Upgrade to this card.\n----------------------------------------\n<b>ACTIVATION PHASE:</b> \n\nThis ship may perform a white 1 [bank-left] or white 1 [bank-right] (Utopia Note: Code missing)",
	 factions: ["federation"],
	 cost: 4,
	 skill: 6,
	 talents: 1,
...
{	 type: "captain",
	 ...
	 name: "Keogh",
	 unique: true,
	 text: "<b>Not Released Yet</b>\n<b>MODIFY ATTACK DICE STEP:</b> When a friendly Federation ship in range is defending and the attacking ship is in this ship's Primary Arc and in range:\n\nConvert 1 [hit] into [blank].",
	 factions: ["federation"],
	 cost: 4,
	 skill: 7,
	 talents: 1,
...
{	 type: "captain",
	 ...
	 name: "Benjamin Sisko",
	 unique: true,
	 text: "<b>Not Released Yet</b>\n<b>WHEN ATTACKING:</b> During the Modify Attack Dice Step, if the defending ship is a Dominion ship or has a Dominion Captain equipped to it:\nAdd 1 [crit]\n----------------------------------------\n<b>END PHASE:</b>\nRemove one [aux] Token beside this ship.",
	 factions: ["federation"],
	 cost: 5,
	 skill: 8,
	 talents: 1
...
{	 type: "captain",
	 ...
	 name: "Kor",
	 unique: true,
	 text: "<b>Not Released Yet</b> You may equip the Dahar Master [talent] Upgrade to this card for 0 SP.\n----------------------------------------\n<b>FREE ACTION:</b> Place an [aux] Token beside this ship and target all friendly Klingon ships.\n\nRemove all Red    [target-lock] Tokens beside the target ships and place them beside this ship. (Utopia Note: Code not implemented)",
	 factions: ["klingon"],
	 cost: 4,
	 skill: 7,
	 range: "1 - 3",
...
{	 type: "captain",
	 ...
	 name: "Koloth",
	 unique: true,
	 text: "<b>Not Released Yet</b>\n\n<b>WHEN AN OPPOSING SHIP WITHIN RANGE PERFORMS A MANEUVER:</b> Place 2 [time] Tokens on this card.\n\nPerform a maneuver on this ship's dial with a speed of 2.",
	 factions: ["klingon"],
	 cost: 4,
	 skill: 7,
	 range: "1 - 2",
...
{	 type: "captain",
	 ...
	 name: "Kang",
	 unique: true,
	 text: "<b>Not Released Yet</b>\n\n<b>WHEN DEFENDING:</b> During the Modify Attack Dice Step, spend this ship's [target-lock] Token.\n\nThe attacking ship must re-roll all of its attack dice.",
	 factions: ["klingon"],
	 cost: 5,
	 skill: 8,
	 talents: 1
